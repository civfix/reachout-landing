    ...
    blocks: [
      ...
      { t: "spread", paras: [
        ...
        { label: "Engineering Team", slot: "about-eng-1", src: "images/about-eng-1.webp", name: "Theodore Bong", role: "Founding Engineer", email: "theo@reachoutla.org", bio: [
          "Theo is studying Physics at Hampton University. He is an experienced programmer, working on various web and video game projects for over 6 years. Primarily focused on software design and user experience, Theo manages frontend software for the Civfix app and information technology for the Reach Out LA organization."
        ]},
  ...
  civfix: {
    ...
    blocks: [
      ...
      { t: "spread", together: true, sidecap: true, paras: [
        ...
        "With a native iOS/Android app for reporting on the spot, and a web app that does everything the same way in a browser, Civfix meets people wherever they are.<br><br>Download the mobile app or visit our web app today!<br>Web: <a href=\"https://civfix.org/\" target=\"_blank\" rel=\"noopener\">civfix.org</a><br><a href=\"https://apps.apple.com/us/app/civfix/id6781838072\" target=\"_blank\" rel=\"noopener\" aria-label=\"Download Civfix on the App Store\" style=\"display:inline-block;margin-top:6px\"><img src=\"images/app-store-badge.svg\" alt=\"Download Civfix on the App Store\" width=\"138\" height=\"46\" style=\"vertical-align:middle\"></a>"
      ], media: [
