    ...
    blocks: [
      ...
      { t: "spread", paras: [
        ...
        { label: "Leadership", slot: "about-president", src: "images/about-president.webp", name: "Roman Aytur", role: "President", email: "roman@reachoutla.org", bio: [
          "Roman founded the organization whilst in high school with the mission of combating rampant homelessness in Los Angeles through the use of technology and cooperation with local governments. Roman has extensive experience in working alongside non-profits through his volunteer work at the St. Francis Center. Additionally, he lead the campaign for unhoused representation in the Los Angeles City Charter reform, partnering with Rewrite LA to include unhoused angelenos in civic assembilies. His work with the California endowment and the Matt Mahan for Governor campaign has opened the door for new legislation to make the lives of all Californians better. Roman discovered a dire need for a more transparent, efficient meithod for organizing cleanups and connecting citizens to their municipal governments regarding issues affecting their communities. Roman pitched his idea for Civfix, raising funds and recruiting the engineering team, bringing the project to life."
        ]},
        { label: "Engineering Team", slot: "about-eng-1", src: "images/about-eng-1.webp", name: "Theodore Bong", role: "Founding Engineer", email: "theo@reachoutla.org", bio: [
          "Theo is studying Physics at UC Merced. He is an experienced programmer, working on various web and video game projects for over 6 years. Primarily focused on software design and user experience, Theo manages frontend software for the Civfix app and information technology for the Reach Out LA organization."
        ]},
  ...
  civfix: {
    ...
    blocks: [
      ...
      { t: "spread", together: true, sidecap: true, paras: [
        ...
        "With a native iOS/Android app for reporting on the spot, and a web app that does everything the same way in a browser, Civfix meets people wherever they are.<br><br>Download the mobile app or visit our web app today!<br><div style=\"display:flex;flex-wrap:wrap;gap:10px;margin-top:8px\"><a href=\"https://civfix.org\" target=\"_blank\" rel=\"noopener\" aria-label=\"Visit Civfix on the Web\" style=\"display:inline-block\"><img src=\"images/web-badge.svg\" alt=\"Visit Civfix on the Web\" width=\"120\" height=\"40\" style=\"vertical-align:middle\"></a><a href=\"https://ios.civfix.org\" target=\"_blank\" rel=\"noopener\" aria-label=\"Download Civfix on the App Store\" style=\"display:inline-block\"><img src=\"images/app-store-badge.svg\" alt=\"Download Civfix on the App Store\" width=\"120\" height=\"40\" style=\"vertical-align:middle\"></a><a href=\"https://android.civfix.org\" target=\"_blank\" rel=\"noopener\" aria-label=\"Get Civfix on Google Play\" style=\"display:inline-block\"><img src=\"images/google-play-badge.svg\" alt=\"Get Civfix on Google Play\" width=\"135\" height=\"40\" style=\"vertical-align:middle\"></a></div>"
      ], media: [
